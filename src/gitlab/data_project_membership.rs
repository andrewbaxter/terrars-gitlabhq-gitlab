...
#[derive(Serialize)]
struct DataProjectMembershipData {
...
struct DataProjectMembership_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<DataProjectMembershipData>,
}

#[derive(Clone)]
pub struct DataProjectMembership(Rc<DataProjectMembership_>);

impl DataProjectMembership {
    ...
    pub fn members(&self) -> ListRef<DataProjectMembershipMembersElRef> {
...
impl Referable for DataProjectMembership {
    fn extract_ref(&self) -> String {
        format!("data.{}.{}", self.0.extract_datasource_type(), self.0.extract_tf_id())
    }
}

impl Datasource for DataProjectMembership { }

impl ToListMappable for DataProjectMembership {
    type O = ListRef<DataProjectMembershipRef>;
...
impl Datasource_ for DataProjectMembership_ {
...
pub struct BuildDataProjectMembership {
    pub tf_id: String,
}

impl BuildDataProjectMembership {
    pub fn build(self, stack: &mut Stack) -> DataProjectMembership {
        let out = DataProjectMembership(Rc::new(DataProjectMembership_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(DataProjectMembershipData {
...
pub struct DataProjectMembershipRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataProjectMembershipRef {
...
#[derive(Serialize)]
pub struct DataProjectMembershipMembersEl {
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl DataProjectMembershipMembersEl {
...
impl ToListMappable for DataProjectMembershipMembersEl {
    type O = BlockAssignable<DataProjectMembershipMembersEl>;
...
pub struct BuildDataProjectMembershipMembersEl {}

impl BuildDataProjectMembershipMembersEl {
    pub fn build(self) -> DataProjectMembershipMembersEl {
        DataProjectMembershipMembersEl {
...
pub struct DataProjectMembershipMembersElRef {
    shared: StackShared,
    base: String,
}

impl Ref for DataProjectMembershipMembersElRef {
    fn new(shared: StackShared, base: String) -> DataProjectMembershipMembersElRef {
        DataProjectMembershipMembersElRef {
            shared: shared,
            base: base.to_string(),
        }
    }
...
impl DataProjectMembershipMembersElRef {
    fn shared(&self) -> &StackShared {
        &self.shared
    }
