...
#[derive(Serialize)]
struct GlobalLevelNotificationsData {
...
struct GlobalLevelNotifications_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<GlobalLevelNotificationsData>,
}

#[derive(Clone)]
pub struct GlobalLevelNotifications(Rc<GlobalLevelNotifications_>);

impl GlobalLevelNotifications {
    ...
    #[doc= "Get a reference to the value of field `id` after provisioning.\nThe ID of the resource.This is a static value named gitlab"]
...
impl Referable for GlobalLevelNotifications {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for GlobalLevelNotifications { }

impl ToListMappable for GlobalLevelNotifications {
    type O = ListRef<GlobalLevelNotificationsRef>;
...
impl Resource_ for GlobalLevelNotifications_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_global_level_notifications".into()
    }
...
pub struct BuildGlobalLevelNotifications {
    pub tf_id: String,
}

impl BuildGlobalLevelNotifications {
    pub fn build(self, stack: &mut Stack) -> GlobalLevelNotifications {
        let out = GlobalLevelNotifications(Rc::new(GlobalLevelNotifications_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(GlobalLevelNotificationsData {
...
pub struct GlobalLevelNotificationsRef {
    shared: StackShared,
    base: String,
}

impl Ref for GlobalLevelNotificationsRef {
...
impl GlobalLevelNotificationsRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
