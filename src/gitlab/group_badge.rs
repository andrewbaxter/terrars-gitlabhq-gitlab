...
struct GroupBadge_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<GroupBadgeData>,
}

#[derive(Clone)]
pub struct GroupBadge(Rc<GroupBadge_>);
...
impl Referable for GroupBadge {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for GroupBadge { }

impl ToListMappable for GroupBadge {
    type O = ListRef<GroupBadgeRef>;
...
impl Resource_ for GroupBadge_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_group_badge".into()
    }
...
pub struct BuildGroupBadge {
    pub tf_id: String,
    #[doc= "The id of the group to add the badge to."]
    pub group: PrimField<String>,
    #[doc= "The image url which will be presented on group overview."]
    pub image_url: PrimField<String>,
    #[doc= "The url linked with the badge."]
    pub link_url: PrimField<String>,
}

impl BuildGroupBadge {
    pub fn build(self, stack: &mut Stack) -> GroupBadge {
        let out = GroupBadge(Rc::new(GroupBadge_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(GroupBadgeData {
...
pub struct GroupBadgeRef {
    shared: StackShared,
    base: String,
}

impl Ref for GroupBadgeRef {
