...
#[derive(Serialize)]
struct IntegrationCustomIssueTrackerData {
...
struct IntegrationCustomIssueTracker_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<IntegrationCustomIssueTrackerData>,
}

#[derive(Clone)]
pub struct IntegrationCustomIssueTracker(Rc<IntegrationCustomIssueTracker_>);

impl IntegrationCustomIssueTracker {
...
impl Referable for IntegrationCustomIssueTracker {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for IntegrationCustomIssueTracker { }

impl ToListMappable for IntegrationCustomIssueTracker {
    type O = ListRef<IntegrationCustomIssueTrackerRef>;
...
impl Resource_ for IntegrationCustomIssueTracker_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_integration_custom_issue_tracker".into()
    }
...
pub struct BuildIntegrationCustomIssueTracker {
    pub tf_id: String,
...
impl BuildIntegrationCustomIssueTracker {
    pub fn build(self, stack: &mut Stack) -> IntegrationCustomIssueTracker {
        let out = IntegrationCustomIssueTracker(Rc::new(IntegrationCustomIssueTracker_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(IntegrationCustomIssueTrackerData {
...
pub struct IntegrationCustomIssueTrackerRef {
    shared: StackShared,
    base: String,
}

impl Ref for IntegrationCustomIssueTrackerRef {
...
impl IntegrationCustomIssueTrackerRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
