...
#[derive(Serialize)]
struct IntegrationEmailsOnPushData {
...
struct IntegrationEmailsOnPush_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<IntegrationEmailsOnPushData>,
}

#[derive(Clone)]
pub struct IntegrationEmailsOnPush(Rc<IntegrationEmailsOnPush_>);

impl IntegrationEmailsOnPush {
...
impl Referable for IntegrationEmailsOnPush {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for IntegrationEmailsOnPush { }

impl ToListMappable for IntegrationEmailsOnPush {
    type O = ListRef<IntegrationEmailsOnPushRef>;
...
impl Resource_ for IntegrationEmailsOnPush_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_integration_emails_on_push".into()
    }
...
pub struct BuildIntegrationEmailsOnPush {
    pub tf_id: String,
...
impl BuildIntegrationEmailsOnPush {
    pub fn build(self, stack: &mut Stack) -> IntegrationEmailsOnPush {
        let out = IntegrationEmailsOnPush(Rc::new(IntegrationEmailsOnPush_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(IntegrationEmailsOnPushData {
...
pub struct IntegrationEmailsOnPushRef {
    shared: StackShared,
    base: String,
}

impl Ref for IntegrationEmailsOnPushRef {
...
impl IntegrationEmailsOnPushRef {
    fn extract_ref(&self) -> String {
        self.base.clone()
    }
