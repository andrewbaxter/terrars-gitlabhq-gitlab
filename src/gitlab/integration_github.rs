...
struct IntegrationGithub_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<IntegrationGithubData>,
}

#[derive(Clone)]
pub struct IntegrationGithub(Rc<IntegrationGithub_>);

impl IntegrationGithub {
...
impl Referable for IntegrationGithub {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for IntegrationGithub { }

impl ToListMappable for IntegrationGithub {
    type O = ListRef<IntegrationGithubRef>;
...
impl Resource_ for IntegrationGithub_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_integration_github".into()
    }
...
pub struct BuildIntegrationGithub {
    pub tf_id: String,
...
impl BuildIntegrationGithub {
    pub fn build(self, stack: &mut Stack) -> IntegrationGithub {
        let out = IntegrationGithub(Rc::new(IntegrationGithub_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(IntegrationGithubData {
...
pub struct IntegrationGithubRef {
    shared: StackShared,
    base: String,
}

impl Ref for IntegrationGithubRef {
