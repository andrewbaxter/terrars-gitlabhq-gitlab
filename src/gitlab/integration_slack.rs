...
struct IntegrationSlackData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    notify_only_default_branch: Option<PrimField<bool>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
struct IntegrationSlack_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<IntegrationSlackData>,
}

#[derive(Clone)]
pub struct IntegrationSlack(Rc<IntegrationSlack_>);

impl IntegrationSlack {
    ...
    #[doc= "Set the field `notify_only_default_branch`.\nThis parameter has been replaced with `branches_to_be_notified`."]
    pub fn set_notify_only_default_branch(self, v: impl Into<PrimField<bool>>) -> Self {
        self.0.data.borrow_mut().notify_only_default_branch = Some(v.into());
        self
    }
    ...
    #[doc= "Get a reference to the value of field `notify_only_default_branch` after provisioning.\nThis parameter has been replaced with `branches_to_be_notified`."]
    pub fn notify_only_default_branch(&self) -> PrimExpr<bool> {
        PrimExpr::new(self.shared().clone(), format!("{}.notify_only_default_branch", self.extract_ref()))
    }
...
impl Referable for IntegrationSlack {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for IntegrationSlack { }

impl ToListMappable for IntegrationSlack {
    type O = ListRef<IntegrationSlackRef>;
...
impl Resource_ for IntegrationSlack_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_integration_slack".into()
    }
...
pub struct BuildIntegrationSlack {
    pub tf_id: String,
    #[doc= "ID of the project you want to activate integration on."]
    pub project: PrimField<String>,
    #[doc= "Webhook URL (Example, https://hooks.slack.com/services/...). This value cannot be imported."]
    pub webhook: PrimField<String>,
}

impl BuildIntegrationSlack {
    pub fn build(self, stack: &mut Stack) -> IntegrationSlack {
        let out = IntegrationSlack(Rc::new(IntegrationSlack_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(IntegrationSlackData {
                ...
                notify_only_default_branch: core::default::Default::default(),
...
pub struct IntegrationSlackRef {
    shared: StackShared,
    base: String,
}

impl Ref for IntegrationSlackRef {
