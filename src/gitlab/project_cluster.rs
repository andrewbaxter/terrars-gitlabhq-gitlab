...
struct ProjectCluster_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ProjectClusterData>,
}

#[derive(Clone)]
pub struct ProjectCluster(Rc<ProjectCluster_>);
...
impl Referable for ProjectCluster {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ProjectCluster { }

impl ToListMappable for ProjectCluster {
    type O = ListRef<ProjectClusterRef>;
...
impl Resource_ for ProjectCluster_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_project_cluster".into()
    }
...
pub struct BuildProjectCluster {
    pub tf_id: String,
    #[doc= "The URL to access the Kubernetes API."]
    pub kubernetes_api_url: PrimField<String>,
    #[doc= "The token to authenticate against Kubernetes."]
    pub kubernetes_token: PrimField<String>,
    #[doc= "The name of cluster."]
    pub name: PrimField<String>,
    #[doc= "The id of the project to add the cluster to."]
    pub project: PrimField<String>,
}

impl BuildProjectCluster {
    pub fn build(self, stack: &mut Stack) -> ProjectCluster {
        let out = ProjectCluster(Rc::new(ProjectCluster_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ProjectClusterData {
...
pub struct ProjectClusterRef {
    shared: StackShared,
    base: String,
}

impl Ref for ProjectClusterRef {
