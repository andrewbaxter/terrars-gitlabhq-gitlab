...
struct ProjectLabel_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ProjectLabelData>,
}

#[derive(Clone)]
pub struct ProjectLabel(Rc<ProjectLabel_>);
...
impl Referable for ProjectLabel {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ProjectLabel { }

impl ToListMappable for ProjectLabel {
    type O = ListRef<ProjectLabelRef>;
...
impl Resource_ for ProjectLabel_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_project_label".into()
    }
...
impl BuildProjectLabel {
    pub fn build(self, stack: &mut Stack) -> ProjectLabel {
        let out = ProjectLabel(Rc::new(ProjectLabel_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ProjectLabelData {
...
pub struct ProjectLabelRef {
    shared: StackShared,
    base: String,
}

impl Ref for ProjectLabelRef {
