...
struct ProjectVariable_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ProjectVariableData>,
}

#[derive(Clone)]
pub struct ProjectVariable(Rc<ProjectVariable_>);
...
impl Referable for ProjectVariable {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ProjectVariable { }

impl ToListMappable for ProjectVariable {
    type O = ListRef<ProjectVariableRef>;
...
impl Resource_ for ProjectVariable_ {
...
pub struct BuildProjectVariable {
    pub tf_id: String,
...
impl BuildProjectVariable {
    pub fn build(self, stack: &mut Stack) -> ProjectVariable {
        let out = ProjectVariable(Rc::new(ProjectVariable_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ProjectVariableData {
...
pub struct ProjectVariableRef {
    shared: StackShared,
    base: String,
}

impl Ref for ProjectVariableRef {
