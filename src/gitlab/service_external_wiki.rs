...
#[derive(Serialize)]
struct ServiceExternalWikiData {
...
struct ServiceExternalWiki_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ServiceExternalWikiData>,
}

#[derive(Clone)]
pub struct ServiceExternalWiki(Rc<ServiceExternalWiki_>);

impl ServiceExternalWiki {
...
impl Referable for ServiceExternalWiki {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ServiceExternalWiki { }

impl ToListMappable for ServiceExternalWiki {
    type O = ListRef<ServiceExternalWikiRef>;
...
impl Resource_ for ServiceExternalWiki_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_service_external_wiki".into()
    }
...
pub struct BuildServiceExternalWiki {
    pub tf_id: String,
...
impl BuildServiceExternalWiki {
    pub fn build(self, stack: &mut Stack) -> ServiceExternalWiki {
        let out = ServiceExternalWiki(Rc::new(ServiceExternalWiki_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ServiceExternalWikiData {
...
pub struct ServiceExternalWikiRef {
    shared: StackShared,
    base: String,
}

impl Ref for ServiceExternalWikiRef {
