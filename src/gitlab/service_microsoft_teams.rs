...
#[derive(Serialize)]
struct ServiceMicrosoftTeamsData {
...
struct ServiceMicrosoftTeams_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ServiceMicrosoftTeamsData>,
}

#[derive(Clone)]
pub struct ServiceMicrosoftTeams(Rc<ServiceMicrosoftTeams_>);

impl ServiceMicrosoftTeams {
...
impl Referable for ServiceMicrosoftTeams {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ServiceMicrosoftTeams { }

impl ToListMappable for ServiceMicrosoftTeams {
    type O = ListRef<ServiceMicrosoftTeamsRef>;
...
impl Resource_ for ServiceMicrosoftTeams_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_service_microsoft_teams".into()
    }
...
pub struct BuildServiceMicrosoftTeams {
    pub tf_id: String,
...
impl BuildServiceMicrosoftTeams {
    pub fn build(self, stack: &mut Stack) -> ServiceMicrosoftTeams {
        let out = ServiceMicrosoftTeams(Rc::new(ServiceMicrosoftTeams_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ServiceMicrosoftTeamsData {
...
pub struct ServiceMicrosoftTeamsRef {
    shared: StackShared,
    base: String,
}

impl Ref for ServiceMicrosoftTeamsRef {
