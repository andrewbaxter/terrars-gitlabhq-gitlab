...
#[derive(Serialize)]
struct ServicePipelinesEmailData {
...
struct ServicePipelinesEmail_ {
    shared: StackShared,
    tf_id: String,
    data: RefCell<ServicePipelinesEmailData>,
}

#[derive(Clone)]
pub struct ServicePipelinesEmail(Rc<ServicePipelinesEmail_>);

impl ServicePipelinesEmail {
...
impl Referable for ServicePipelinesEmail {
    fn extract_ref(&self) -> String {
        format!("{}.{}", self.0.extract_resource_type(), self.0.extract_tf_id())
    }
}

impl Resource for ServicePipelinesEmail { }

impl ToListMappable for ServicePipelinesEmail {
    type O = ListRef<ServicePipelinesEmailRef>;
...
impl Resource_ for ServicePipelinesEmail_ {
    fn extract_resource_type(&self) -> String {
        "gitlab_service_pipelines_email".into()
    }
...
pub struct BuildServicePipelinesEmail {
    pub tf_id: String,
...
impl BuildServicePipelinesEmail {
    pub fn build(self, stack: &mut Stack) -> ServicePipelinesEmail {
        let out = ServicePipelinesEmail(Rc::new(ServicePipelinesEmail_ {
            shared: stack.shared.clone(),
            tf_id: self.tf_id,
            data: RefCell::new(ServicePipelinesEmailData {
...
pub struct ServicePipelinesEmailRef {
    shared: StackShared,
    base: String,
}

impl Ref for ServicePipelinesEmailRef {
